...
| AI-2 | 启发式评估 | evaluator 路线评分，按分排序切牌 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **AI-3 (激进进攻型)** | **19** | **38.0%** | 5 | 14 | 6 | -54 |
| AI-1 (MCTS搜索) | 10 | 20.0% | 2 | 8 | 6 | -54 |
| AI-4 (保守防守型) | 6 | 12.0% | 1 | 5 | 6 | **-51** |
| AI-2 (启发式评估) | 5 | 10.0% | 1 | 4 | 13 | -130 |

> **结论**：推倒胡规则下，**攻 > 守**。激进型 AI 胜率 38% 碾压全场。保守型虽点炮少但进攻乏力。启发式评估防守最差（点炮 13 次）。
